...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FICHIERADMIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_FICHIERADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FICHIERADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FICHIERADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FICHIERADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FICHIERADMIN actions', async () => {
      const expectedActions = [
        {
