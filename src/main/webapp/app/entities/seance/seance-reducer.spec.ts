...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './seance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEANCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEANCE actions', async () => {
      const expectedActions = [
        {
