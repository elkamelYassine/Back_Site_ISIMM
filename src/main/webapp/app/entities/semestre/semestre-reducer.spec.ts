...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './semestre.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEMESTRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEMESTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEMESTRE actions', async () => {
      const expectedActions = [
        {
