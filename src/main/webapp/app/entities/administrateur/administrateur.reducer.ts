...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IAdministrateur, thunkAPI) => {
    return axios.post<IAdministrateur>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IAdministrateur, thunkAPI) => {
    return axios.put<IAdministrateur>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IAdministrateur, thunkAPI) => {
    return axios.patch<IAdministrateur>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IAdministrateur>(requestUrl);
  },
  { serializeError: serializeAxiosError },
);
