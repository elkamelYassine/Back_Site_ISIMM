...
export const AdministrateurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="isimmManagerApp.administrateur.delete.question">
        <Translate contentKey="isimmManagerApp.administrateur.delete.question" interpolate={{ id: administrateurEntity.id }}>
