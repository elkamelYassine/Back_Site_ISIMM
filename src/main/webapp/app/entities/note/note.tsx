  ...
  return (
    <div>
      <h2 id="note-heading" data-cy="NoteHeading">
        <Translate contentKey="isimmManagerApp.note.home.title">Notes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="isimmManagerApp.note.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/note/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="isimmManagerApp.note.home.createLabel">Create new Note</Translate>
          </Link>
        </div>
      </h2>
        ...
        {noteList && noteList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="isimmManagerApp.note.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('note')}>
                  <Translate contentKey="isimmManagerApp.note.note">Note</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="isimmManagerApp.note.home.notFound">No Notes found</Translate>
            </div>
          )
        )}
      </div>
