...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './actulaite.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTULAITE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTULAITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTULAITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTULAITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTULAITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTULAITE actions', async () => {
      const expectedActions = [
        {
